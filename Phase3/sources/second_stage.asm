...
;********************************* Main Program **************************************
      ...
      ;call video_cls_16  ;; A limitation found with this functopn is that the last 2 messages in stage 2 which are -> pic disabled and PML4 mapped successfully 
                          ;;appear too quickly then the screen clears 
                        ;; so with the comment everything with appear and to test that video.asm is working remove the comment.
...
space                         db ' ',0
double_space                  db '  ',0
entering_third_stage_msg            db 'Entering Third Stage !!',13,10,0
testing db 'Test',13,10,0
